    ...
    <div>
      ...
      <div className="py-6">
        <div className="relative flex flex-col gap-8">
          {filteredData?.map((unit, index) => (
            <Circle
              ...
              variant={
                unit.isLast ? "last" : unit.isLocked ? "locked" : "default"
              }
              key={index}
        ...
        <div className="pt-[3.5rem] pb-3">
          <AlertDialog
            onOpenChange={setIsOpenFinishDialog}
          ...
          >
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  You're finish all the game that given! Wait us for the next
                  games and improvement given from us!
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
